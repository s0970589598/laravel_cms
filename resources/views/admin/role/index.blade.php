...
<script type="text/html" id="action">
    <a href="<% d.editUrl %>" class="layui-table-link" title="編輯角色"><i class="layui-icon layui-icon-edit"></i></a>
    <a href="<% d.permissionUrl %>" class="layui-table-link" style="margin-left: 10px" title="分配權限"><i class="layui-icon layui-icon-auz"></i></a>
</script>
