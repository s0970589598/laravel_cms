...
@section('content')
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
                ...
                <div class="layui-col-xs3">
                    <div style="padding: 10px 0">
                        <div style="margin-bottom: 10px">
                            <span class="layui-badge layui-bg-blue">新增標簽</span>
                        </div>
                    ...
                    <form class="layui-form" action="{{ route('admin::tag.save') }}" method="post">
                        ...
                        <div class="layui-form-item">
                            <button class="layui-btn" lay-submit lay-filter="formAddTag" id="submitBtn">新增標簽</button>
                        </div>
                    </form>
                        </div>
                    </div>
            ...
            <table class="layui-table" lay-data="{url:'{{ route('admin::tag.list') }}?{{ request()->getQueryString() }}', page:true, limit:50, id:'test', toolbar:'<div><a href=\'{{ route('admin::tag.create') }}\'><i class=\'layui-icon layui-icon-add-1\'></i>新增標簽</a></div>'}" lay-filter="test">
                <thead>
                <tr>
