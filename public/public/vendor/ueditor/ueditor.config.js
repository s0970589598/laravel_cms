 ...
 * 當升級編輯器時，可直接使用旧版配置文件替换新版配置文件,不用担心旧版配置文件中因缺少新功能所需的参數而导致脚本報錯。
 **************************提示********************************/
...
(function () {
     ...
     * "相對於网站根目入的相對路径"也就是以斜杠開頭的形如"/myProject/ueditor/"這樣的路径。
    ...
    window.UEDITOR_CONFIG = {
        ...
        //,initialContent:'歡迎使用ueditor!'    //初始化編輯器的内容,也可以通過textarea/script给值，看官网例子

        //,autoClearinitialContent:true //是否自動清除編輯器初始内容，注意：如果focus屬性設置為true,這個也為真，那麼編輯器一上来就會觸發导致初始化的内容看不到了
