...
UE.I18N['ja-jp'] = {
    'labelMap':{
        ...
        'mergecells':'覆數のセルをマージする', 'deletetable':'テーブルを削除する', 'cleardoc':'ドキュメントをクリアする','insertparagraphbeforetable':"テーブルの前に行を挿入する",'insertcode':'コード言語',
        'fontfamily':'フォント', 'fontsize':'フォントサイズ', 'paragraph':'段落書式', 'simpleupload':'単一画像アップロード', 'insertimage':'覆數画像アップロード','edittable':'表屬性','edittd':'セル屬性', 'link':'ハイパーリンク',
    ...
    'wordOverFlowMsg':'<span style="color:red;">文字の數が許容される最大値を超えているため、サーバーは保存を拒否する可能性があります。！</span>',
    'ok':"ok",
    'cancel':"キャンセル",
    'closeDialog':"閉じる",
