...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'lineheight':'行间距','edittip' :'编辑提示','customstyle':'自定义標題', 'autotypeset':'自动排版',
    ...
    'insertimage':{
        'static':{
            ...
            'searchType':{'title':"图片類型", 'options':["全部類型", "头像图片", "面部特写", "卡通画", "简笔画", "动态图片", "静态图片"]}, //select的option
    ...
    'link':{
        ...
        'httpPrompt':'您输入的超链接中不包含http等协议名称，默认将為您添加http://前缀'
    },
    'map':{
        'static':{
            lang_city:"城市",
