...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'unlink':'取消連接', 'insertrow':'前插入行', 'insertcol':'前插入列', 'mergeright':'右合并單元格', 'mergedown':'下合并單元格',
        'deleterow':'删除行', 'deletecol':'删除列', 'splittorows':'拆分成行',
        'splittocols':'拆分成列', 'splittocells':'完全拆分單元格','deletecaption':'删除表格標題','inserttitle':'插入標題',
        'mergecells':'合并多個單元格', 'deletetable':'删除表格', 'cleardoc':'清空文档','insertparagraphbeforetable':"表格前插入行",'insertcode':'代码语言',
        'fontfamily':'字体', 'fontsize':'字号', 'paragraph':'段落格式', 'simpleupload':'單圖上傳', 'insertimage':'多圖上傳','edittable':'表格属性','edittd':'單元格属性', 'link':'超連接',
        ...
        'lineheight':'行间距','edittip' :'編輯提示','customstyle':'自定義標題', 'autotypeset':'自動排版',
        'webapp':'百度应用','touppercase':'字母大写', 'tolowercase':'字母小写','background':'背景','template':'模板','scrawl':'涂鸦',
        'music':'音乐','inserttable':'插入表格','drafts': '从草稿箱加载', 'charts': '圖表'
    },
    'insertorderedlist':{
        'num':'1,2,3...',
        'num1':'1),2),3)...',
    ...
    'autoupload': {
        ...
        'loading':"正在上傳...",
        'loadError':"上傳错误",
        'errorLoadConfig': '編輯配置项没有正常加载，上傳插件不能正常使用！'
    },
    'simpleupload':{
        'exceedSizeError': '文件大小超出限制',
        'exceedTypeError': '文件格式不允许',
    ...
    'snapScreen_plugin':{
        'browserMsg':"仅支持IE浏览器！",
        'callBackErrorMsg':"服务器返回數據有误，请检查配置项之后重试。",
        'uploadErrorMsg':"截圖上傳失败，请检查服务器端环境! "
    },
    'insertcode':{
        'as3':'ActionScript 3',
        'bash':'Bash/Shell',
    ...
    'background':{
        'static':{
            ...
            'repeatType':{'options':["居中", "横向重复", "纵向重复", "平铺","自定義"]}
    ...
    'insertimage':{
        'static':{
            ...
            'searchType':{'title':"圖片類型", 'options':["全部類型", "头像圖片", "面部特写", "卡通画", "简笔画", "动态圖片", "静态圖片"]}, //select的option
        ...
        'imageLoadError':"圖片加载失败！请检查連接地址或网络狀態！",
        'searchRemind':"请输入搜索關鍵词",
    ...
    'attachment':{
        'static':{
            ...
            'lang_start_upload':"開始上傳",
            'lang_drop_remind':"可以将文件拖到這里，單次最多可選100個文件"
        },
        'uploadSelectFile':'点擊選擇文件',
        'uploadAddFile':'继续添加',
        'uploadStart':'開始上傳',
        'uploadPause':'暂停上傳',
        'uploadContinue':'继续上傳',
    ...
    'help':{
        'static':{
            ...
            'lang_input_introduction':'UEditor是由百度web前端研發部開發的所见即所得副文本web編輯器，具有轻量，可定制，注重用户体验等特点。開源基于BSD协议，允许自由使用和修改代码。',
    ...
    'link':{
        ...
        'validLink':'只支持選中一個連接时生效',
        'httpPrompt':'您输入的超連接中不包含http等协议名稱，默認将為您添加http://前缀'
    },
    'map':{
        'static':{
            lang_city:"城市",
    ...
    'searchreplace':{
        'static':{
            ...
            lang_search2:"查找",
            lang_replace:"替换",
            lang_searchReg:'支持正则表达式，添加前后斜杠标示為正则表达式，例如“/表达式/”',
            lang_searchReg1:'支持正则表达式，添加前后斜杠标示為正则表达式，例如“/表达式/”',
        ...
        getEnd:"已经搜索到文章末尾！",
        getStart:"已经搜索到文章头部",
        countMsg:"总共替换了{#count}處！"
    },
    'snapscreen':{
        'static':{
            lang_showMsg:"截圖功能需要首先安装UEditor截圖插件！ ",
            lang_download:"点此下载",
            lang_step1:"第一步，下载UEditor截圖插件并运行安装。",
    ...
    'wordimage':{
        'static':{
            ...
            lang_step:"1、点擊顶部複製按钮，将地址複製到剪贴板；2、点擊添加照片按钮，在弹出的對话框中使用Ctrl+V粘贴地址；3、点擊打開后選擇圖片上傳流程。"
        },
        'fileType':"圖片",
