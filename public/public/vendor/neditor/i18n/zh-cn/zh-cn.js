...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'splittocols':'拆分成列', 'splittocells':'完全拆分单元格','deletecaption':'删除表格標題','inserttitle':'插入標題',
        'mergecells':'合并多个单元格', 'deletetable':'删除表格', 'cleardoc':'清空文档','insertparagraphbeforetable':"表格前插入行",'insertcode':'代码语言',
        'fontfamily':'字体', 'fontsize':'字号', 'paragraph':'段落格式', 'simpleupload':'单圖上傳', 'insertimage':'多圖上傳','edittable':'表格属性','edittd':'单元格属性', 'link':'超链接',
    ...
    'attachment':{
        ...
        'updateStatusConfirm': '已成功上傳_个文件，_个文件上傳失败',
    ...
    'insertvideo':{
        ...
        'uploadPreview':'预览中',
        'updateStatusReady': '選中_个文件，共_KB。',
        'updateStatusConfirm': '成功上傳_个，_个失败',
    ...
    'help':{
        'static':{
            ...
            'lang_input_introduction':'UEditor是由百度web前端研发部開发的所见即所得副文本web編輯器，具有轻量，可定制，注重用户体验等特点。開源基于BSD协议，允许自由使用和修改代码。',
    ...
    'insertframe':{
        'static':{
            ...
            'align':{title:"对齐方式", options:["默認", "左对齐", "右对齐", "居中"]}
        },
        'enterAddress':'请输入地址!'
    },
    'link':{
    ...
    'wordimage':{
        'static':{
            ...
            lang_step:"1、点击顶部複製按钮，将地址複製到剪贴板；2、点击添加照片按钮，在弹出的对话框中使用Ctrl+V粘贴地址；3、点击打開后選擇圖片上傳流程。"
        },
        'fileType':"圖片",
