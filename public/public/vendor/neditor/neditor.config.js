...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        catcherFieldName : "file", /* 送出的圖片列表表單名称 */
        ...
        zIndex: 1100 //編輯器层级的基數,默認是900
            ...
            //若实例化編輯器的頁面手动修改的domain，此处需要设置為true
            //,customDomain:false
            ...
            //,initialContent:'欢迎使用neditor!'    //初始化編輯器的内容,也可以通过textarea/script给值，看官网例子
            ...
            //,iframeJsUrl: '' //给編輯区域的iframe引入一个js文件
            ...
            //,allHtmlEnabled:false //送出到后台的數據是否包含整个html字符串
            ...
            //tab
            //点击tab键时移动的距离,tabSize倍數，tabNode什么字符做為单位
            //,tabSize:4
            //,tabNode:'&nbsp;'
        ...
        autoHeightEnabled: false
            ...
            //allowLinkProtocol 允许的链接地址，有这些前缀的链接地址不会自動添加http
            //, allowLinkProtocols: ['http:', 'https:', '#', '/', 'ftp:', 'mailto:', 'tel:', 'git:', 'svn:']

            //webAppKey 百度应用的APIkey，每个站长必须首先去百度官网註冊一个key后方能正常使用app功能，註冊介绍，http://app.baidu.com/static/cms/getapikey.html
            //, webAppKey: ""
