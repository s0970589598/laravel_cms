...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        toolbars: [
            ...
            //当鼠标放在工具栏上时显示的tooltip提示,留空支持自动多语言配置，否则以配置值為准
            //,labelMap:{
            //    'anchor':'', 'undo':''
            //}
        ...
        zIndex: 1100 //编辑器层级的基数,默认是900
            ...
            //,textarea:'editorValue' // 送出表单时，服务器获取编辑器送出内容的所用的参数，多实例时可以给容器name属性，会将name给定的值最為每个实例的键值，不用每次实例化的时候都设置这个值

            //,initialContent:'欢迎使用neditor!'    //初始化编辑器的内容,也可以通过textarea/script给值，看官网例子

            //,autoClearinitialContent:true //是否自动清除编辑器初始内容，注意：如果focus属性设置為true,这个也為真，那么编辑器一上来就会触发导致初始化的内容看不到了
            ...
            //insertorderedlist
            //有序列表的下拉配置,值留空时支持多语言自动识别，若配置值，则以此值為准
            //,'insertorderedlist':{
            //      //自定的样式
            //        'num':'1,2,3...',
            //        'num1':'1),2),3)...',
            ...
            //insertunorderedlist
            //无序列表的下拉配置，值留空时支持多语言自动识别，若配置值，则以此值為准
            ...
            //paragraph
            //段落格式 值留空时支持多语言自动识别，若配置，则以配置值為准
            ...
            //tab
            //点击tab键时移动的距离,tabSize倍数，tabNode什么字符做為单位
            //,tabSize:4
            //,tabNode:'&nbsp;'
