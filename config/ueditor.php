<?php
/*注意：此配置来自 ueditor 官方包中，仅供参考。LightCMS 編輯并未完全实现其相關功能，有需要可自行扩展实现*/
...
return [
    ...
    "imageManagerUrlPrefix" => "", /* 圖片访問路径前缀 */
