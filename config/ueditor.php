...
return [
    /* 上传图片配置项 */
    "imageActionName" => "uploadimage", /* 執行上传图片的action名称 */
    ...
    "scrawlFieldName" => "upfile", /* 送出的图片表单名称 */
    ...
    /* 截图工具上传 */
    "snapscreenActionName" => "uploadimage", /* 執行上传截图的action名称 */
    ...
    "catcherFieldName" => "source", /* 送出的图片列表表单名称 */
    ...
    "videoFieldName" => "upfile", /* 送出的视频表单名称 */
    ...
    "fileFieldName" => "upfile", /* 送出的文件表单名称 */
    ...
    /* 列出指定目录下的图片 */
    "imageManagerActionName" => "listimage", /* 執行图片管理的action名称 */
